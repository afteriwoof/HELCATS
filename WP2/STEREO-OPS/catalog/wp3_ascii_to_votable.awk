...
BEGIN {
	...
	print "        <DESCRIPTION>The postion angle used in the time-elongation fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"FP Speed\" ID=\"col10\" ucd=\"phys.flow;phys.veloc\" datatype=\"int\" width=\"4\" unitss=\"kms-1\"  >"
        print "        <DESCRIPTION>CME speed using on Fixed-Phi fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"FP Speed Err\" ID=\"col11\" ucd=\"phys.flow;phys.veloc\" datatype=\"int\" width=\"4\" unitss=\"kms-1\"  >"
        print "        <DESCRIPTION>Uncertainty in speed using Fixed-Phi fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"FP Phi\" ID=\"col12\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>Spacecraft-Sun-CME angle using Fixed-Phi fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"FP Phi Err\" ID=\"col13\" ucd=\"pos.ecliptic.lat;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>Uncertainty in Spacecraft-Sun-CME angle using on Fixed-Phi fitting</DESCRIPTION></FIELD>"
	print "      <FIELD name=\"FP HEEQ Long\" ID=\"col14\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        ...
        print "      <FIELD name=\"FP Carr Long\" ID=\"col15\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME Carrington Longitude using Fixed-Phi fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"FP Launch\" ID=\"col17\" ucd=\"time.epoch\" datatype=\"char\" arraysize=\"17*\" xtype=\"iso8601\" >"
        print "        <DESCRIPTION>CME Launch time (r=0) using Fixed-Phi fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE Speed\" ID=\"col18\" ucd=\"phys.flow;phys.veloc\" datatype=\"int\" width=\"4\" unitss=\"kmx-1\"  >"
        print "        <DESCRIPTION>CME speed using on Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE Speed Err\" ID=\"col19\" ucd=\"phys.flow;phys.veloc\" datatype=\"int\" width=\"4\" unitss=\"kms-1\"  >"
        print "        <DESCRIPTION>Uncertainty in speed using Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE Phi\" ID=\"col20\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>Spacecraft-Sun-CME angle using Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE Phi Err\" ID=\"col21\" ucd=\"pos.ecliptic.lat;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>Uncertainty in Spacecraft-Sun-CME angle using Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE HEEQ Long\" ID=\"col22\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME HEEQ Longitude using on Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE HEEQ Lat\" ID=\"col24\" ucd=\"pos.ecliptic.lat;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME HEEQ Latitude using on Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE Carr Long\" ID=\"col23\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME Carrington Longitude using Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"SSE Launch\" ID=\"col25\" ucd=\"time.epoch\" datatype=\"char\" arraysize=\"17*\" xtype=\"iso8601\" >"
        print "        <DESCRIPTION>CME Launch time (r=0) using Self-Similar Expansion fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM Speed\" ID=\"col26\" ucd=\"phys.flow;phys.veloc\" datatype=\"int\" width=\"4\" unitss=\"kmx-1\"  >"
        print "        <DESCRIPTION>CME speed using on Harmonic-Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM Speed Err\" ID=\"col27\" ucd=\"phys.flow;phys.veloc\" datatype=\"int\" width=\"4\" unitss=\"kms-1\"  >"
        print "        <DESCRIPTION>Uncertainty in speed using Harmonic-Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM Phi\" ID=\"col28\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>Spacecraft-Sun-CME angle using Harmonic-Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM Phi Err\" ID=\"col29\" ucd=\"pos.ecliptic.lat;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>Uncertainty in Spacecraft-Sun-CME angle using Harmonic Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM HEEQ Long\" ID=\"col30\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME HEEQ Longitude using on Harmonic-Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM HEEQ Lat\" ID=\"col32\" ucd=\"pos.ecliptic.lat;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME HEEQ Latitude using on Harmonic-Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM Carr Long\" ID=\"col31\" ucd=\"pos.ecliptic.long;pos.heliocentric\" datatype=\"int\" width=\"4\" unitss=\"deg\"  >"
        print "        <DESCRIPTION>CME Carrington Longitude using Harmonic-Mean fitting</DESCRIPTION></FIELD>"
        print "      <FIELD name=\"HM Launch\" ID=\"col33\" ucd=\"time.epoch\" datatype=\"char\" arraysize=\"17*\" xtype=\"iso8601\" >"
