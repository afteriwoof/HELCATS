...
PRO combine_wp2_lists, test=test

	print, "Running code: combine_wp2_lists"
	dir = getenv('HELCATS') ;'/soft/ukssdc/share/Solar/HELCATS'
	dir_codes = getenv('HELCATS_CODES') ;dir + '/codes'
	dir_input = getenv('HI_CATALOGUE') ; dir + '/HI_catalogue'
	dir_output = getenv('WP2_CATALOGUE') ;dir + '/WP2_catalogue'
